...
If you are working on the book, you will need to install this package first. `sqlpetr` has a `pkgdown` site at <https://smithjd.github.io/sqlpetr/>,
...
3. Source the file `install_me.R`. The script will install the package and rebuild the `pkgdown` site.
